...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("amf2eiyn")

  // remove
  collection.schema.removeField("4mg4qtlz")

  // remove
  collection.schema.removeField("vfdjhzo7")

  // remove
  collection.schema.removeField("w428eggc")
