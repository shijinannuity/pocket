...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ur41izyr")

  // remove
  collection.schema.removeField("ekby5aor")

  // remove
  collection.schema.removeField("g7upe7jv")

  // remove
  collection.schema.removeField("97frzzpf")
  ...
  // remove
  collection.schema.removeField("3bomsbpy")

  // remove
  collection.schema.removeField("qznqwflq")

  // remove
  collection.schema.removeField("oami5cgg")

  // remove
  collection.schema.removeField("usyo9pyd")
