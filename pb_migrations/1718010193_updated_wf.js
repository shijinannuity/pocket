...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ikkvlou4")

  // remove
  collection.schema.removeField("thlszpvs")

  // remove
  collection.schema.removeField("agnprnmm")

  // remove
  collection.schema.removeField("ufywjpxc")
