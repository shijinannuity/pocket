...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("ex2drygp")

  // remove
  collection.schema.removeField("jsq7jtis")
  ...
  // remove
  collection.schema.removeField("nmslkar0")

  // remove
  collection.schema.removeField("arjvuejm")
