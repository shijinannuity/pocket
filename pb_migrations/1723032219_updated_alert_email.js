...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("sajcmg4b")

  // remove
  collection.schema.removeField("yui9bycy")

  // remove
  collection.schema.removeField("ckccterq")

  // remove
  collection.schema.removeField("c4iawme5")

  // remove
  collection.schema.removeField("0drbc86s")

  // remove
  collection.schema.removeField("sgfqsslv")

  // remove
  collection.schema.removeField("ncgyfhie")

  // remove
  collection.schema.removeField("0luwxezj")
