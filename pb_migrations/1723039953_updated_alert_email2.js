...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("hgkqv76i")

  // remove
  collection.schema.removeField("bsgvmxlx")

  // remove
  collection.schema.removeField("qlzceppz")

  // remove
  collection.schema.removeField("pid8ixuv")

  // remove
  collection.schema.removeField("4upyl78q")

  // remove
  collection.schema.removeField("ejassx8f")

  // remove
  collection.schema.removeField("q9ubzsds")

  // remove
  collection.schema.removeField("0vfsly2d")

  // remove
  collection.schema.removeField("uqiuoavq")
